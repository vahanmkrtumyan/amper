                                ...
                                <div className="accordion_wrap_all">
                                    ...
                                    <div className="accordion_wrap">
                                        <div className="glax_tm_accordion">
                                            <div className={`accordion_in ${Accordion==1 ? "acc_active" : ""}`}>
                                                <div onClick={() => AccordionToggle(1)} className="acc_head">We are guided by the same basic precepts<div className="wow_shape"><span className="wow_effect" /></div></div>
                                                <div className="acc_content" style={Accordion==1 ? {} : {display: "none"}}>
                                            ...
                                            <div className={`accordion_in ${Accordion==2 ? "acc_active" : ""}`}>
                                                <div onClick={() => AccordionToggle(2)} className="acc_head">Glax&apos;s work ethic runs deep<div className="wow_shape"><span className="wow_effect" /></div></div>
                                                <div className="acc_content" style={Accordion==2 ? {} : {display: "none"}}>
                                            ...
                                            <div className={`accordion_in ${Accordion==3 ? "acc_active" : ""}`}>
                                                <div onClick={() => AccordionToggle(3)} className="acc_head">We have created a culture<div className="wow_shape"><span className="wow_effect" /></div></div>
                                                <div className="acc_content" style={Accordion==3 ? {} : {display: "none"}}>
